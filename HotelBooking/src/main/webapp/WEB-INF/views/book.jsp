...
<div class="container">
    ...
    <div id="hotelCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/hotel1.jpg" class="d-block w-100" alt="Hotel 1">
            </div>
            <div class="carousel-item">
                <img src="images/hotel11.jpg" class="d-block w-100" alt="Hotel 2">
            </div>
    ...
    <h2>HOTEL SUN CITY</h2>
    <p>C-56, G Block, Hotel Sun City Complex, Bandra</p>
    <p>Mumbai Central</p>
</div>
